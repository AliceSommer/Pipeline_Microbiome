...
```
    ...
    ##                                  group '1' group '2'
    ## Relative LCC size                  0.20714   0.28571
    ## Clustering coefficient             0.48724   0.45000
    ## Moduarity                          0.32796   0.39723
    ## Positive-to-negative ratio         3.00000   2.60870
    ## Edge density                       0.16749   0.10641
    ## Natural connectivity               0.05114   0.03490
    ## Average dissimilarity*             0.69428   0.69507
    ## Average (shortest) path length**   2.51376   3.38766
...
![](5.2.1_Networks_viz_Gen_smoke_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
