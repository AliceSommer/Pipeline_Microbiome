...
legend("bottom", 
       inset = c(0,.07),
       legend=levels(phyl_ps_prune), ncol = 3,
...
![](5.2_Networks_viz_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
legend(x=-.03, y=-.9, legend=legend_cats$size_text, pt.cex=legend_cats$size_circle/11, bty="n", cex = .8,
       col="#777777", pch=21, pt.bg="lightgray", ncol = 2, y.intersp = 1.7, x.intersp = 1.5, 
       title = "Module size (nb. of nodes):")
```

![](5.2_Networks_viz_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
